...
import com.example.msigl62.coworkandroiduset.ui.profile.ProfileFragment
            ...
            when (tabId) {
                ...
                R.id.profile -> {
                    ...
                    if (nameUserLogin.isNotEmpty()) {
                        supportFragmentManager.beginTransaction().replace(R.id.containerFragment, ProfileUserFragment()).commit()
                    } else {
